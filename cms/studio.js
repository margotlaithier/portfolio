            ...
            <div class="studio-panel">
                <div class="studio-card">
                    ...
                    <div class="studio-grid-3">
                        ...
                        <div class="studio-field"><label>Taille carte</label><select data-project-field="cardSize"><option value="third"${project.cardSize === 'third' ? ' selected' : ''}>third</option><option value="half"${project.cardSize === 'half' ? ' selected' : ''}>half</option><option value="four"${project.cardSize === 'four' ? ' selected' : ''}>four</option><option value="six"${project.cardSize === 'six' ? ' selected' : ''}>six</option><option value="eight"${project.cardSize === 'eight' ? ' selected' : ''}>eight</option><option value="square"${project.cardSize === 'square' ? ' selected' : ''}>square</option></select></div>
                        <div class="studio-field"><label>Format carte</label><select data-project-field="cardAspect"><option value="auto"${!project.cardAspect || project.cardAspect === 'auto' ? ' selected' : ''}>auto</option><option value="landscape"${project.cardAspect === 'landscape' ? ' selected' : ''}>paysage</option><option value="landscape-wide"${project.cardAspect === 'landscape-wide' ? ' selected' : ''}>paysage large</option><option value="widescreen"${project.cardAspect === 'widescreen' ? ' selected' : ''}>16:9</option><option value="portrait-tall"${project.cardAspect === 'portrait-tall' ? ' selected' : ''}>portrait haut</option><option value="portrait"${project.cardAspect === 'portrait' ? ' selected' : ''}>portrait</option><option value="portrait-wide"${project.cardAspect === 'portrait-wide' ? ' selected' : ''}>portrait large</option><option value="square"${project.cardAspect === 'square' ? ' selected' : ''}>carré</option></select></div>
                        <div class="studio-field"><label>Ratio exact carte</label><input data-project-field="cardRatio" placeholder="ex. 1920 / 1080" value="${escapeHtml(project.cardRatio || '')}" /></div>
                        <div class="studio-field"><label>Ajustement image</label><select data-project-field="cardImageFit"><option value="cover"${project.cardImageFit !== 'contain' ? ' selected' : ''}>remplir</option><option value="contain"${project.cardImageFit === 'contain' ? ' selected' : ''}>image entière</option></select></div>
                    </div>
                    <div class="studio-grid">
