            ...
            <div class="studio-panel">
                <div class="studio-card">
                    ...
                    <div class="studio-grid-3">
                        ...
                        <div class="studio-field"><label>Format carte</label><select data-project-field="cardAspect"><option value="auto"${!project.cardAspect || project.cardAspect === 'auto' ? ' selected' : ''}>auto</option><option value="landscape"${project.cardAspect === 'landscape' ? ' selected' : ''}>paysage</option><option value="landscape-wide"${project.cardAspect === 'landscape-wide' ? ' selected' : ''}>paysage large</option><option value="portrait"${project.cardAspect === 'portrait' ? ' selected' : ''}>portrait</option><option value="square"${project.cardAspect === 'square' ? ' selected' : ''}>carré</option></select></div>
